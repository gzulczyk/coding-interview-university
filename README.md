...
- ### Arrays
    ...
    - [X] [Implement a vector (mutable array with automatic resizing)](https://github.com/gzulczyk/coding-interview-university/blob/main/exercises/vectors.c)
...
- ### Stack
    ...
    - [ ] Implement
        ...
        - [X] clear() — removes all items from the stack
...
- ### Bitwise operations
    ...
    - [X] Implement:
        ...
        - [X] abs_value(n) - computes absolute value without branching using the sign bit; use `mask = n >> 31; (n + mask) ^ mask`
        - [X] count_different_bits(a, b) - most complex; XOR marks differences then counts resulting 1-bits; use `popcount(a ^ b)`
